...
function addPlatforms() {
  ...
  platforms.create(550, 150, 'platform2');
  platforms.create(650, 275, 'platform2');
  platforms.create(375, 350, 'platform');
  platforms.create(300, 450, 'platform2');
  platforms.create(100, 550, 'platform');
  platforms.create(550, 550, 'platform');
  platforms.create(25, 375, 'platform2');
  platforms.create(125, 325, 'platform2');
  platforms.create(225, 150, 'platform');
  platforms.create(75, 100, 'platform2');
...
window.onload = function () {
  ...
  function preload() {
    ...
    game.load.spritesheet('player2', 'mikethefrog.png', 32, 32);
  }

  // initial game set up
  function create() {
    player = game.add.sprite(50, 600, 'player2');
    ...
    text2 = game.add.text(250, 16, "LIVES: " + currentLives, { font: "bold 24px Arial", fill: "white" });
